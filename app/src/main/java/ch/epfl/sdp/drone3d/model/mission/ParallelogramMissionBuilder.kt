...
class ParallelogramMissionBuilder {
    companion object{
         ...
         */
        fun buildSinglePassMappingMission(startingPoint: Point, area: Parallelogram, cameraPitch:Float, flightHeight:Double, groundImageDimension: GroundImageDim):List<Point>{
         ...
         * The camera pitch is at 0 when the drone looks forward and at PI/2 when the drone looks downwards
         */
        fun buildDoublePassMappingMission(startingPoint: Point, area: Parallelogram, cameraPitch:Float, flightHeight:Double, groundImageDimension: GroundImageDim):List<Point>{
         ...
         * The camera pitch is at 0 when the drone looks forward and at PI/2 when the drone looks downwards
         */
        private fun singlePassMappingMission(area: Parallelogram, cameraPitch:Float, flightHeight:Double, groundImageDimension: GroundImageDim):List<Point>{
         ...
         */
        private fun singlePassMappingMission(area: Parallelogram, groundImageDimension: GroundImageDim,mainDirectionCompensation:Double):List<Point>{

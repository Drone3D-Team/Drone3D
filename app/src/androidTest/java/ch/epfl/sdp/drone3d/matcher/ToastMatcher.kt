...
object ToastMatcher {
   ...
   fun onToast(activity: Activity, text: String) = onView(withText(text)).inRoot(isToast(activity))!!

    fun onToast(activity: Activity, textId: Int) = onView(withText(textId)).inRoot(isToast(activity))!!

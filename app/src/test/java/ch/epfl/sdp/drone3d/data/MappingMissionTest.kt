...
class MappingMissionTest {
    ...
    fun equalsReturnTrueIfEqual() {
        val mappingMission1 = MappingMission(listOf(LatLng(0.0, 0.0), LatLng(1.0, 1.0)),"Map Lausanne")
        val mappingMission2 = MappingMission(listOf(LatLng(0.0, 0.0), LatLng(1.0, 1.0)),"Map Lausanne")
    ...
    fun equalsReturnFalseIfNotEqual() {
        val mappingMission1 = MappingMission(listOf(LatLng(0.0, 0.0), LatLng(1.0, 1.0)),"Map Lausanne")
        val mappingMission2 = MappingMission(listOf(LatLng(0.0, 0.1), LatLng(1.0, 1.0)),"Map Lausanne")
    ...
    fun serializationAndDeserializationForTwoCoordinatesMissionIsCorrect() {
        val mappingMission = MappingMission(listOf(LatLng(0.0, 0.0), LatLng(1.0, 1.0)),"Map Lausanne")
        assertThat(
